...
from pipeline.metadata import complete_run, fail_run, start_run
...
from pipeline.ml.feature_store import build_feature_matrix, load_ml_config, prepare_train_test_split
...
def run_ml_pipeline(
    ...
    try:
        ...
        explain_report = _tracked_ml_stage(
            "explain",
            lambda: explain_model(experiment, split, config)
        )
